...
//    public List<CategorieBook> showCategorieBooksByBook(@PathVariable int bookId){
//        return(categorieBookService.findByBook(bookService.findById(bookId)));
//    }
//    
//    @CrossOrigin
//    @GetMapping("/categorie/{categorieId}")
//    public List<CategorieBook> showCategorieBooksByCategorie(@PathVariable int categorieId){
//        return(categorieBookService.findByCategorie(categorieService.findById(categorieId)));
//    }
